...
class OneLogin_Saml2_AuthnRequest
{
     ...
     */
    public function __construct($indexAcs, OneLogin_Saml2_Settings $settings, $forceAuthn = false, $isPassive = false, $setNameIdPolicy = true)
    {
...
REQUESTEDAUTHN;
        ...
        $acsUrl = htmlspecialchars($spData['assertionConsumerService'][$indexAcs]['url'], ENT_QUOTES);
